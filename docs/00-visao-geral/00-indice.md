# Índice geral da documentação WFlyer
...
- `../pages/07-compartilhados.md`
- `../pages/08-configuracoes.md`
- `../pages/09-dashboard-futuro.md`
- `../pages/10-admin-futuro.md`
...
- `../backend/10-admin-api.md`
- `../backend/11-push-notifications.md`
