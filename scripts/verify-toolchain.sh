...
if openspec validate bootstrap-core-foundation --strict >/dev/null 2>&1; then
  pass 'mudança OpenSpec válida em modo estrito'
else
  fail 'mudança OpenSpec inválida em modo estrito'
fi
